...
export default {
	...
	methods: {
		...
		getAddressDetail(id) {
			var _this = this;
			_this.$common.httpGet('user_agent/userAddress/getById/' + id).then(res => {
						...
						if (!pattern.test(_this.tel)) {
							...
							if (_this.lotusAddressData.provinceName) {
								if (_this.address) {
									...
									// console.log(_data)
									this.$common.httpPost('user_agent/userAddress/insert', _data).then(res => {
										// console.log(res)
				...
				if (_this.tel) {
					if (_this.lotusAddressData.provinceName) {
						if (_this.address) {
							...
							this.$common.httpPost('user_agent/userAddress/update', _data).then(res => {
