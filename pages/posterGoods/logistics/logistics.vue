...
<script>
	...
	export default {
		...
		methods: {
			getLogisitics() {
				this.$common.httpGet("/order_agent/tracking/getTracking/list?orderNo=" + this.option.id).then((res) => {
					// console.log('res',res)
			...
			getTracking(e) {
				...
				this.$common.httpGet("/order_agent/tracking/getTracking/subpackage?trackingSn=" + e).then((res) => {
					let arr = []
