		...
		<view class="groupGoodsDetails-bottom">
			<view class="groupGoodsDetails-bottom-left">
				<view class="iconImg" @click="goIndex">
					<view class="iconfont icon-yemian-copy-copy" style="font-size: 48rpx; color: #4A90E2;"></view>
				</view>
				<view class="iconImg2" @click="goUserInfo">
					<view class="iconfont icon-mine-gray" style="font-size: 48rpx; color: #4A90E2;"></view>
				</view>
			</view>
